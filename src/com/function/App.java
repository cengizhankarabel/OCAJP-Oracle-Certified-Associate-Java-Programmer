...
public class App {
	public static void main(String[] args) {
		...
		for(Employee e: empList) {
			double newSalary= calculateSalary(e, emp -> emp.getSalary() *1.1);
			System.out.println(e.getEmpName()+" old salary is: "+e.getSalary()+" new salary is: "+newSalary);
		}

	}
	public static double calculateSalary(Employee e, Function<Employee, Double> fn) {
		return fn.apply(e);
	}
